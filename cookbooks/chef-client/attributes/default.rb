...
node.default['chef_client']['config']['foreman_server_url'] = 'https://sgvlapaacchefn2.bcc.ap.abn'
node.default['chef_client']['config']['foreman_facts_upload'] = true
node.default['chef_client']['config']['foreman_reports_upload'] = true
node.default['chef_client']['config']['reports_log_level'] = 'notice'
